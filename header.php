...
$hasImportedAccounts = cdcompta_has_imported_accounts();
$applicationUrl      = $hasImportedAccounts ? cdcompta_get_application_page_url() : cdcompta_get_import_page_url();
$applicationLabel    = $hasImportedAccounts
    ? __('Ouvrir la comptabilite', CDCOMPTA_TEXT_DOMAIN)
    : __('Charger un OFX', CDCOMPTA_TEXT_DOMAIN);
?>
<!doctype html>
        ...
        <div class="corbidev-compta-theme-header__inner">
            ...
            <div class="corbidev-compta-theme-nav">
                ...
                <a class="corbidev-compta-theme-button" href="<?php echo esc_url($applicationUrl); ?>">
                    <?php echo esc_html($applicationLabel); ?>
                </a>
            </div>
        </div>
    </header>
